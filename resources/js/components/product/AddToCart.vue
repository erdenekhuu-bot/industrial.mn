<template>
    <v-row class="">
        ...
        <v-col md="6" lg="7">
            ...
            <template v-if="!isLoading">
                <h1 class="fs-21 opacity-80 mb-3 lh-1-3">
                    {{ productDetails.name }}
                </h1>
                ...
                <v-row class="mt-4 gutters-5" v-if="!productDetails.is_digital">
                    <v-col cols="12" sm="6">
                        <div
                            class="bg-soft-primary border border-primary rounded px-4 py-3 lh-1 stock_admin_contact_btn"
                        >
                            <div class="mb-3 d-flex align-center">
                                ...
                                >
                                    <i
                                        class="las la-check bg-green rounded-circle size-15px fs-8 white-text d-inline-flex align-center justify-center me-3"
                                    ></i>
                                    <span class="fs-12">{{
                                        $t("in_stock")
                                    }}</span>
                    ...
                    <v-col cols="12" sm="6">
                        <div
                            class="bg-grey-lighten-3 border-gray-300 rounded px-4 py-3 d-flex lh-1-3"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="20"
    ...
    methods: {
        ...
        addCart() {
            if (
                ...
                this.currentUser.user_type != "customer"
            ) {
                this.snack({
                    message: this.$i18n.t(
