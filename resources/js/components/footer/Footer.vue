    ...
    <footer class="bg-grey-darken-4 pt-8 text-white pb-14 pb-md-10 pb-lg-0">
        <v-container class="main-footer">
                ...
                <v-col class="mb-5 d-none d-lg-block" lg="2" cols="12">
                    ...
                    >
                        ...
                        >
                            <img
                                :src="
                                    static_asset('/assets/img/play_store.png')
                                "
                                class="mw-100"
                                height="40"
                            />
                        ...
                        <router-link
                            v-if="
                                this.generalSettings.delivery_boy == 1 &&
                                !this.isAuthenticated
                            "
            ...
            <v-row class="py-5">
                ...
                <v-col md="6" cols="12">
                    <ul
                        class="list-unstyled d-flex justify-start justify-md-end mt-2 ps-0"
                    >
                        <li
