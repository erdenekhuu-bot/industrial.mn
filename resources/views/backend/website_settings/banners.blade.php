    ...
    <div class="card-body">
        <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row gutters-10">
                <div class="col-lg-3">
                    <label class="from-label d-block">Background хэсгийн баннер</label>
                    <small>{{ translate('Recommended size').' 520x475' }}</small>
                </div>
                <input type="hidden" name="background_page_banner" class="selected-files">
                <div class="col-lg-4">
                    <div class="form-group">
                        {{-- <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="types[]" value="background_page_banner">
                            <input type="hidden" name="background_page_banner" class="selected-files">
                        </div> --}}
                         <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="types[]" value="background_page_banner">
                            <input type="file" name="background_page_banner" class="selected-files">
                        <div class="file-preview box sm"></div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <input type="hidden" name="types[]" value="background_page_banner_link">
                    <input type="text" placeholder="" name="background_page_banner_link" value="{{ get_setting('login_page_banner_link') }}" class="form-control">
                </div>
            </div>
            <div class="form-group row gutters-10">
                <div class="col-lg-3">
