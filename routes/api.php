...
Route::group(['prefix' => 'v1', 'as' => 'api.'], function () {
    ...
    Route::group(['prefix'=>'background'], function(){
        Route::get('/', [SwipperBackground::class, 'index'])->name('background');
        Route::get('/find/{name}',[SwipperBackground::class, 'find']);
        Route::post('/create', [SwipperBackground::class, 'create'])->name('background.create');
        Route::delete('/remove/{id}', [SwipperBackground::class, 'remove'])->name('background.remove');
    });
});
